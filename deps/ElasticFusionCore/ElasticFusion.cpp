...
//    std::cout << "rgbtexwidth" << textures[GPUTexture::RGB]->texture->width <<std::endl;
//    std::cout << "rgbtexheight" << textures[GPUTexture::RGB]->texture->height <<std::endl;
//    std::cout << "dtexheight" << textures[GPUTexture::DEPTH_RAW]->texture->height <<std::endl;
//    std::cout << "dtexe" << textures[GPUTexture::DEPTH_RAW]->texture->width <<std::endl;
//    std::cout << "rgb[460000]" << (int)rgb[460000] <<std::endl;
//    std::cout << "d[153600]" << depth[153600] <<std::endl;
